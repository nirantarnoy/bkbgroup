...
//            echo basename($_FILES['file_card']['name']);return;
       ...
       // $active_date = date('Y-m-d H:m:i');
        ...
        $sql = "INSERT INTO member (account_id,name,dob,id_number,phone,bank_id,bank_account,is_level2,id_card_photo,bank_photo,status,active_date,created_by)
           VALUES ('$account_id','$name','$m_dob','$id_number','$phone','$bank_id','$bank_account','$lv2','$card_photo','$bank_photo','$status','$active_date','$userid')";
